...
if __name__=="__main__":
    ...
    # def iinorder_traversal(node):
    #     result = []
    #     _iinorder_traversal(node, result)
    #     return result

    # def _iinorder_traversal(node, result):
    #     if node:
    #         _iinorder_traversal(node.left, result)
    #         result.append((node.bin_id, node.capacity))
    #         _iinorder_traversal(node.right, result)
    # print(iinorder_traversal(gcms.treebyBinCap.root))

    try:
        gcms.add_object(8989, 6, Color.RED)
    except Exception as e:
        print(f"Object 1 was not able to be added: {e}")
